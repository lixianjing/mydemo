...
import com.xian.myapp.activities.ExpandableListviewActivity;
...
public class CustomELVAdapter extends BaseExpandableListAdapter implements ExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
         ...
         final ExpandableListviewActivity.ViewHolder holder = new ExpandableListviewActivity.ViewHolder(v);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        View v = convertView;
        ExpandableListviewActivity.ViewHolder holder;
        if(v==null){
        v = vi.inflate(GROUP_ITEM_RESOURCE, null);
        holder = new ExpandableListviewActivity.ViewHolder(v);
        v.setTag(holder);
        }else{
        	holder = (ExpandableListviewActivity.ViewHolder) v.getTag();
        }
