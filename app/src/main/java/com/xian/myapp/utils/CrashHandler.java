...
import com.xian.myapp.activities.MyActivity;

/**
 * Created by lucien on 2015/9/2.
 */
    ...
    MyApplication application;
        ...
        public void uncaughtException(Thread thread, Throwable ex) {
            if(!handleException(ex) && mDefaultHandler != null){
                ...
                Intent intent = new Intent(application.getApplicationContext(), MyActivity.class);
